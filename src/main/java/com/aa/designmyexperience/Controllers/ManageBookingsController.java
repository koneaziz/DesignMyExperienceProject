    ...
    private void initialize() {
        ...
        if (currentUser != null) {
            try {
                ...
                List<Order> orders = DBconnect.getOrdersByOwner(currentUser.getId());
        ...
        ordersListView.setCellFactory(listView -> new ListCell<Order>() {
            ...
            protected void updateItem(Order order, boolean empty) {
                ...
                if (empty || order == null) {
                    ...
                    if (loader == null) {
                        loader = new FXMLLoader(getClass().getResource("/com/aa/designmyexperience/manage-bookings-cell.fxml"));
                        try {
                            loader.load();
                        } catch (IOException e) {
                            e.printStackTrace();
                    ...
                    ManageBookingsCellController cellController = loader.getController();
